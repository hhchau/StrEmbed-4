...
sub XXX_new_step_produce_assembly_has_parent {
    # i/p - @parent_child_pair
    # o/p - \%assembly
    #     - \%has_parent
...
sub XXX_step_top_level_assembly {  # replaced by find_top_level_assembly
                                   # independent of step file
                                   # but from @parent_child_pair
