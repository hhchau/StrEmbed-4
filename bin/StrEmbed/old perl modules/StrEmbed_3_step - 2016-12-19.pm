...
sub step_produce_parent_child_pairs {
    ### taken from STEP file via (i) cdsr-rr-sr
    ###                         (ii) cdsr-pds-nano-pd-pdfwss-p
...
sub read_step_file {
    ...
    my $file = "../step_data/input/lock_6-pin_assembly_eg_less_one.STEP";
